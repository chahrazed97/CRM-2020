                    ...
                    <form class="card" action="{{ route('admin.ajouter.evenement') }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="datetime-local" name="date" placeholder="entrer la date et l'heure" id="example-date-input">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="localisation" placeholder="entrer la localisation" id="example-time-input">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-lg" type="text" name="description" placeholder="donner une description" id="example-text-input-lg">
