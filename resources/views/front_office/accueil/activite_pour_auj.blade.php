                                ...
                                <div class="well well-sm">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-1">
                                            <div class="row">
                                                <a class="lien-ch" href="{{ route('index.emails', ['client_id' => 0,  'produit_id' => 0, 'promo_id' => 0, 'event_id' => 0, 'reclam_id' => 0, 'activite_id' => $activite->id, 'type' => 'activite']) }}" data-toggle="tooltip" data-placement="left" title="Effectuer l'activité"><button class="btn btn-rounded btn- btn-sm"><i class="fa fa-send"></i></button></a>
